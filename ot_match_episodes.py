...
def main(args):
    os.makedirs('visual/ot_episode_matching_new', exist_ok=True)
    ...
    # ot_res = optimal_transport_plan(human_init_latent, rollout_init_latent, dist_mat)
    
    # Visualization
    os.makedirs(f'visual/ot_episode_matching_new', exist_ok=True)
    ...
    for k, human_corr_idx in enumerate(human_corr_indices):
        ...
        combined_image.save(f'visual/ot_episode_matching_new/rollout_{k}.png')
