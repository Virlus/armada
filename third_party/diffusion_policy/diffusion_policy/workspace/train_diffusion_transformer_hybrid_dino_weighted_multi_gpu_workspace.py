...
class TrainDiffusionTransformerHybridDinoWeightedMultiGPUWorkspace(BaseWorkspace):
...
def main(cfg):
    workspace = TrainDiffusionTransformerHybridDinoWeightedMultiGPUWorkspace(cfg)
    workspace.run()
